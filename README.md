MySQL Group Project on 0x02. AirBnB clone - MySQL by David Effanga and Edet Isong
...
Update FileStorage: (models/engine/file_storage.py)
    ...
    Update the prototype of def all(self) to def all(self, cls=None) - that returns the list of objects of one type of class. Example below with State - it’s an optional file
